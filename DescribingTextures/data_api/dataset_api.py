...
class TextureDescriptionData:
    def __init__(self, phrase_split='train', phrase_freq_thresh=1, phid_format='set'):
...
class WordEncoder:
    def __init__(self, word_freq_file='word_freq_train.txt', word_freq_thresh=1, special_chars=",;/&()-'"):
        self_path = os.path.realpath(__file__)
        self_dir = os.path.dirname(self_path)
